...
export function ProductNameEditor({ id, initialName }: { id: string, initialName: string }) {
  ...
  const { isEditable, startEdit, stopEdit } = useEditLock('product-name');
  ...
  return (
    <div className="flex flex-col gap-2 mb-2">
      ...
      <div className="flex gap-2">
        <Button variant="ghost" size="sm" onClick={handleCancel} disabled={loading} className="h-8 px-2 text-xs">
